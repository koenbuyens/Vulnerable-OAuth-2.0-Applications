...
// TODO: public pics (all users), private pics (only me), possibly sharing of
// pics (certain users)

/* ***********************************
* User functionality                 *
**************************************/
// updates an image - vulnerability: direct object reference; can update pics
// of all users
router.put('/:username/:imageid', auth.ensureLoggedIn,
    photoscontroller.updateImage);
// deletes an image  - vulnerability: direct object reference; can delete pics
// of all users
router.delete('/:username/:imageid', auth.ensureLoggedIn,
    photoscontroller.deleteImage);
// creates an image
